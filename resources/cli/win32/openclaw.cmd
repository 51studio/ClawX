...
if /i "%1"=="update" (
    echo openclaw is managed by DPClaw ^(bundled version^).
    echo.
    echo To update openclaw, update DPClaw:
    echo   Open DPClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=DPClaw
