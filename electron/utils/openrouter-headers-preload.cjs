 ...
 * "openrouter.ai" carries the DPClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__dpclawFetchPatched) return;
  globalThis.__dpclawFetchPatched = true;

  globalThis.fetch = function dpclawFetch(input, init) {
    var url =
