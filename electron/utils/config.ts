 ...
 */
export const PORTS = {
  /** DPClaw GUI development server port */
  DPCLAW_DEV: 5173,
  
  /** DPClaw GUI production port (for reference) */
  DPCLAW_GUI: 23333,

  /** Local host API server port */
  DPCLAW_HOST_API: 13210,
...
export const APP_PATHS = {
  ...
  /** DPClaw configuration directory */
  DPCLAW_CONFIG: '~/.dpclaw',
